...
{
    QListWidgetItem *item1 = new QListWidgetItem(QIcon(":/E:/color/green.jpg"), "Зеленый");
    this->addItem(item1);

    QListWidgetItem *item2 = new QListWidgetItem(QIcon(":/E:/color/red.jpg"), "Красный");
    this->addItem(item2);

    QListWidgetItem *item3 = new QListWidgetItem(QIcon(":/E:/color/orange.jpg"), "Оранжевый");
    this->addItem(item3);

    QListWidgetItem *item4 = new QListWidgetItem(QIcon(":/E:/color/blue.png"), "Синий");
    this->addItem(item4);

    QListWidgetItem *item5 = new QListWidgetItem(QIcon(":/E:/color/yellow.png"), "Желтый");
    this->addItem(item5);
}
